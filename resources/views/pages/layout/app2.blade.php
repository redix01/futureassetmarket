...
<body>
    ...
    <div class="boxed_wrapper dark_home ltr">
                ...
                <div class="auto-container">
                    <div class="outer-box">
                        <figure class="logo-box">
                            <a href="{{ route('index') }}">
                                <img src="{{ asset('img2/logo.png') }}" alt="Future Asset Market">
                            </a>
                        </figure>
                        <div class="menu-area">
        ...
        <div class="mobile-menu">
            ...
            <nav class="menu-box">
                <div class="nav-logo"><a href="{{ route('index') }}"><img src="{{ asset('img2/logo.png') }}" alt="Future Asset Market" title="Future Asset Market"></a></div>
                    ...
                    <div class="row clearfix">
                        <div class="col-lg-8 col-md-12 col-sm-12 big-column">
                            ...
                            <div class="footer-lower">
                                <figure class="footer-logo"><a href="{{ route('index') }}"><img src="{{ asset('img2/logo.png') }}" alt="Future Asset Market"></a></figure>
                        ...
                        <div class="col-lg-4 col-md-6 col-sm-12 footer-column">
                            <div class="footer-widget logo-widget centred ml_80">
                                <div class="widget-content">
                                    <figure class="footer-logo mb_15"><a href="{{ route('index') }}"><img src="{{ asset('img2/logo.png') }}" alt="Future Asset Market"></a></figure>
