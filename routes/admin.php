...
Route::group(['middleware' => ['auth', 'verified', 'admin'], 'prefix' => 'admin', 'as' => 'admin.'], function () {
    ...
    Route::put('trade-room/profit/{id}', [\App\Http\Controllers\Admin\TradeRoomController::class, 'updateTradeRoomProfit'])->name('updateTradeRoomProfit');
    Route::put('trade-room/close/{id}', [\App\Http\Controllers\Admin\TradeRoomController::class, 'closeTradeRoom'])->name('closeTradeRoom');
